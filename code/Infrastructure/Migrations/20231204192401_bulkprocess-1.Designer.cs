...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20231204192401_bulkprocess-1")]
    partial class bulkprocess1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.BulkProcess.BulkProcess", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Entities.BulkProcess.Component", b =>
                {
                    b.Property<long>("Id")
                        .HasColumnType("bigint")
                        .HasColumnName("id");
                    ...
                    b.ToTable("Component", "Workflow");
                });

            modelBuilder.Entity("Domain.Entities.BulkProcess.ComponentProperty", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Domain.Entities.BulkProcess.Component", b =>
                {
                    b.HasOne("Domain.Entities.BulkProcess.BulkProcess", "BulkProcess")
            ...
            modelBuilder.Entity("Domain.Entities.BulkProcess.ComponentProperty", b =>
                {
                    b.HasOne("Domain.Entities.BulkProcess.Component", null)
            ...
            modelBuilder.Entity("Domain.Entities.WorkflowsAggregate.DynamicForm", b =>
                {
                    b.HasOne("Domain.Entities.BulkProcess.BulkProcess", null)
